...
def validate_component_manifest(data: Union[dict, str, Path]) -> ComponentManifest:
    try:
        ...
        raise ManifestValidationError(f"Unexpected error validating manifest: {e}") from e
...
def validate_pack_manifest(data: Union[dict, str, Path]) -> PackManifest:
    try:
        ...
        raise ManifestValidationError(f"Unexpected error validating pack manifest: {e}") from e
