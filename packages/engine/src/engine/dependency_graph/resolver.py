...
class DependencyResolver:
    ...
    def resolve(self, requested_nodes: List[DependencyNode], available_nodes: Dict[NodeId, DependencyNode], target_framework: str = None) -> ResolutionResult:
        ...
        visited: Set[NodeId] = set([n.id for n in requested_nodes])
        ...
        return ResolutionResult(
            resolved_nodes=list(graph.nodes.values()),
            edges=graph.edges,
