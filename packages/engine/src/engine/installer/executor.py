...
class InstallExecutor:
    def __init__(self, logger: LoggerProtocol, fs: FileSystemProtocol, downloader: DownloaderService, verifier: InstallationVerifier, bus: EventBus):
        self.logger = logger
        self.fs = fs
    ...
    def execute(self, plan: InstallPlan, project_dir: Path):
        ...
        try:
            ...
            raise InstallError(f"Installation aborted and rolled back: {e}")
