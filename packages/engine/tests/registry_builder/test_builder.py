...
from engine.registry_builder.errors import ResolutionError
...
def test_circular_dependency(builder, fs, tmp_path):
    ...
    fs.write_text_atomic(
        comp_a / "manifest.json",
        '{"id": "a", "slug": "a", "name": "A", "description": "A", "version": "1.0.0", "author": "me", "license": "MIT", "category": "Cat", "supportedFrameworks": ["customtkinter"], "componentDependencies": ["b"]}',
    )

    fs.write_text_atomic(comp_b / "component.py", "")
    fs.write_text_atomic(comp_b / "README.md", "")
    fs.write_text_atomic(
        comp_b / "manifest.json",
        '{"id": "b", "slug": "b", "name": "B", "description": "B", "version": "1.0.0", "author": "me", "license": "MIT", "category": "Cat", "supportedFrameworks": ["customtkinter"], "componentDependencies": ["a"]}',
    )
...
def test_successful_build(builder, fs, tmp_path):
    ...
    fs.write_text_atomic(
        comp_a / "manifest.json",
        '{"id": "btn", "slug": "btn", "name": "Btn", "description": "Btn", "version": "1.0.0", "author": "me", "license": "MIT", "category": "Buttons", "supportedFrameworks": ["customtkinter"]}',
    )
